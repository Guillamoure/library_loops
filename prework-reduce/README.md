...
highest_page_count: highest_page_count takes in your library as an argument, and outputs the longest book.
(Bonus: try to complete this method using the .reduce method)
